                ...
                <div class="p-6">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                            Data kategori beserta semua pengeluaran terkait akan dihapus permanen dan tidak bisa dikembalikan.
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <form action="{{ route('hapus.kategori', ['id' => $id]) }}" method="POST" class="flex-1">
                            @method('DELETE')
                            @csrf
