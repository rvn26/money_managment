<div>
    @if($show)
        <div class="fixed overflow-y-auto inset-0 bg-black/50 z-50 flex items-center justify-center">
            <div class="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <!-- Modal header -->
                ...
                <!-- Modal body -->
                <form action="{{ route('simpan.kategori.tagihan') }}" method="POST">
                    @csrf
