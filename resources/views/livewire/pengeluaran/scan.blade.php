                    ...
                    @if ($file)
                        @if (!$isScanned)
                            <div>
                                ...
                                <div class="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 flex justify-center p-2">
                                    <img src="{{ $file->temporaryUrl() }}" alt="Preview"
                                        class="max-h-[320px] w-auto rounded-lg object-contain shadow">
                                </div>
                            </div>
                        @else
                            <div class="rounded-xl border border-gray-200 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden text-sm">
