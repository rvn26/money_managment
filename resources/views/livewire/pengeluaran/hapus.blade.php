            ...
            <div class="relative w-full max-w-sm mx-4 bg-white rounded-2xl shadow-xl dark:bg-gray-800"
                ...
                <div class="p-6">
                    ...
                    <div class="text-center mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Hapus Pengeluaran?</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                            Data pengeluaran ini akan dihapus permanen dan tidak bisa dikembalikan.
                        </p>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <form action="{{ route('pengeluaran.hapus', ['id' => $id]) }}" method="POST" class="flex-1">
                            @method('DELETE')
                            @csrf
